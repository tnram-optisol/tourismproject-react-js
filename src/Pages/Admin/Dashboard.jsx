...
import { adminGetOrders, adminGetUsers } from "Services/api/adminAPI";
...
function Dashboard(props) {
  const packages = useSelector((state) => state.tour.value.tour);
  const users = useSelector((state) => state.admin.value.users);
  const orders = useSelector((state) => state.admin.value.orders);
